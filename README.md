...
2. The OTF-VF is based on CFF2 table. It will not work if the software is not well-supported, and in that case use these font may cause problems. Therefore, you may choose the TTF-VF for better compatibility. 
